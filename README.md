...
**Version 0.2.0** is a cooperative, base-game campaign using stock Factorio graphics
...
2. Download [FactorioAI_0.2.0.zip](builds/FactorioAI_0.2.0.zip). Remove older
...
The map contains an operating circuit factory, a substation grid, a northern import
...
* **Corporate Exports** has a standing receiving train. Load its chests or wagons
  whenever you wish. Accepted goods count once per second, up to the current order.
...
Back up a save before upgrading. Version 0.1.x saves retain their factory, current
contract, delivered goods, research and suspicion. An export dock is added in an
unoccupied southern corridor. Old loading chests and contents stay where they are;
...
The implementation and starting factory are written from scratch. Thanks to Wube
...
attacks, electric interfaces, plumbing and the freeplay/silo remote interfaces. Stock graphics remain referenced in the installation;
